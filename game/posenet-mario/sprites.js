...
var mountainImages = ['assets/game-images/scene/mountains01.png', 'assets/game-images/scene/mountains02.png', 'assets/game-images/scene/mountains03.png', 'assets/game-images/scene/mountains04.png'];
var cloudImages = ['assets/game-images/scene/cloud01.png', 'assets/game-images/scene/cloud02.png'];
var brickImages = ['assets/game-images/blocks/blocks001.png', 'assets/game-images/blocks/blocks002.png', 'assets/game-images/blocks/blocks003.png'];
var coinsImags = ['assets/game-images/blocks/coin01.png', 'assets/game-images/blocks/coin05.png'];
var pipeImages = ['assets/game-images/scene/tube.png'];
var platformImages = ['assets/game-images/scene/platform.png'];
var enemyMushroomImage = ['assets/game-images/enemy/enemyMushroom01.png', 'assets/game-images/enemy/enemyMushroom02.png'];
...
function loadPlatforms() {
	img = loadImage('assets/game-images/scene/platform.png');
	for (i = 0; i < 70; i++) {
		randomNumber = random();
		if (randomNumber > 0.2) {
...
function MarioAnimation() {
	...
	mario.addAnimation("stand", 'assets/game-images/mario/mario06.png');
	mario.addAnimation("move", 'assets/game-images/mario/mario01.png', 'assets/game-images/mario/mario03.png');
	mario.addAnimation("crouch", 'assets/game-images/mario/mario18.png');
	mario.addAnimation("jump", 'assets/game-images/mario/mario05.png');
	mario.addAnimation("dead", 'assets/game-images/mario/mario24.png');
};
